...
import HeroMetricTicker from './HeroMetricTicker';
...
export default function HeroSection() {
  ...
  return (
    <section className="from-background via-background to-primary/5 relative overflow-hidden rounded-[32px] border border-white/10 bg-gradient-to-br p-6 shadow-lg shadow-black/5">
      <div className="pointer-events-none absolute inset-0">
        <div className="bg-primary/20 dark:bg-primary/30 absolute top-6 -left-10 h-40 w-40 rounded-full blur-3xl" />
        <div className="absolute top-12 right-4 h-32 w-32 rounded-full bg-emerald-300/30 blur-3xl dark:bg-emerald-400/30" />
        <div className="absolute inset-0 animate-[spin_28s_linear_infinite] opacity-40 [background:radial-gradient(circle_at_center,_rgba(255,255,255,0.12),_transparent_60%)]" />
      </div>
        ...
        <div className="space-y-10">
          <div className="space-y-6">
            ...
            <h1 className="text-4xl leading-tight font-semibold tracking-tight text-balance sm:text-5xl">
              Spend with confidence and understand what is left for the goals
              that matter.
            </h1>
            <p className="text-muted-foreground text-lg">
              Financemore keeps income, spending, and savings targets organized
              so you always know where money is going.
            </p>
            <HeroMetricTicker />
          </div>
